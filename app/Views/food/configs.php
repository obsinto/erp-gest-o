                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="">URL Vídeo</label>
                                            <input type="text" class="form-control" name="url_video_painel" value="<?= $config_painel['url_video_painel'] ?>">
                                        </div>
                                    </div><div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="">TEXTO DO LETREIRO</label>
