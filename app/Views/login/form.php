                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">								
                            ...
                            <div class="col-lg-3" style="border: 1px solid lightgrey;">
                                <label style="margin-top: 10px">PAINEL SENHAS</label>
                            ...
                            <div class="col-lg-3" style="border: 1px solid lightgrey;">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="">Configs FOOD e Painel</label>
                            ...
                            <div class="col-lg-6" style="border: 1px solid lightgrey; background: lightgrey">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="">Widget Vendas e Orçamentos</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="">Widget Faturamento e Gráfico Faturamento Diário</label>
