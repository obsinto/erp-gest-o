        ...
        <nav class="mt-2" style="margin-bottom: 140px">
            <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <?php else : ?>
                    ...
                    ?>
                    <li id="11.x" class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php if ($controle_de_acesso['transmitir_no_painel'] == 1) : ?>
                                <li class="nav-item">
                                    <a id="11.1" href="/painel/transmitir" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li id="12.x" class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <?php if ($controle_de_acesso['configs'] == 1) : ?>
                                    <li class="nav-item">
                                        <a id="12.4" href="/food/configs" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Configs Food e Painel</p>
                                        </a>
                                    </li>
                                <?php endif; ?>
