...
<?php if ($configuracao['arquivo-imagem-de-fundo-login'] != "") : ?>
    ...
    <body class="hold-transition login-page" style="background-image: url('<?= base_url('assets/img/login') . "/" . $configuracao['arquivo-imagem-de-fundo-login'] ?>'); background-size: 100% 100%; background-repeat: no-repeat;">
    <?php else : ?>
            ...
            <div class="card">
                <div class="card-body login-card-body">
                    <div class="login-logo">
                        <img src="<?= base_url('assets/img/logomarcas') ?>/<?= ($configuracao['logomarca'] != "") ? $configuracao['logomarca'] : "logo-marca.png" ?>" style="width: 120px">
                    </div>
                    <div class="login-logo">
